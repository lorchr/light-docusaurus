- [SELECT COUNT(*) 会造成全表扫描](https://mp.weixin.qq.com/s/b289PKFdEEIjn4cbgGGyzA)
...
| table_name | Engine | Version | Row_format | Rows   | Avg_row_length | Data_length | Max_data_length | Index_length | Data free |
| ---------- | ------ | ------- | ---------- | ------ | -------------- | ----------- | --------------- | ------------ | --------- |
