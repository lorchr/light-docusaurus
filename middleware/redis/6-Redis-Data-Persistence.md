- [Redis数据持久化](https://mp.weixin.qq.com/s/V2Mro9VYp2BCmBnOM-Y-jg)
...
Multi Part AOF 不是重点，了解即可，详细介绍可以看看阿里开发者的Redis 7.0 Multi Part AOF 的设计和实现[1] 这篇文章。

相关 issue：Redis 的 AOF 方式 #783[2]。
...
相关 issue：Redis AOF 重写描述不准确 #1439[3]。
...
## 如何选择 RDB 和 AOF？
关于 RDB 和 AOF 的优缺点，官网上面也给了比较详细的说明Redis persistence[4]，这里结合自己的理解简单总结一下。
