...
![saml2 web sso authentication request filter](./img/4/4-1.png)
...
![Locate the Federation Metadata XML File](./img/4/4-2.jpeg)

![Metadata Path](./img/4/4-3.webp)
...
![Import Keeper Metadata](./img/4/4-5.jpeg)

输入显示名称

![Enter a Display Name: Keeper SSO Connect Cloud](./img/4/4-6.webp)

选择访问控制策略

![Choose an access control policy](./img/4/4-7.png)

配置Logout端点

![SAML Logout Endpoints](./img/4/4-8.webp)
...
![Edit Claim Issuance Policy](./img/4/4-9.webp)

添加规则

![Add Rule...](./img/4/4-10.webp)

选择规则类型

![Choose Rule Type](./img/4/4-11.webp)
