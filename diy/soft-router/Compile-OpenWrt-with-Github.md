- [使用Github的Actions自动编译打造自己的OpenWrt](https://zhuanlan.zhihu.com/p/507321946)
- [U3DC/Actions-OpenWrt](https://github.com/U3DC/Actions-OpenWrt)
- [coolsnowwolf/lede](https://github.com/coolsnowwolf/lede)
- [haiibo/OpenWrt](https://github.com/haiibo/OpenWrt)
- [lorchr/Actions-OpenWrt](https://github.com/lorchr/Actions-OpenWrt)

[OpenWrt](https://zh.wikipedia.org/wiki/OpenWrt)是适合于[嵌入式](https://zh.wikipedia.org/wiki/%E5%B5%8C%E5%85%A5%E5%BC%8F%E7%B3%BB%E7%BB%9F)设备的一个[Linux](https://zh.wikipedia.org/wiki/Linux)发行版，目前小到一些轻量级开发板，大到X86架构的All In One，都可以使用OpenWrt，主要还是用来做软路由的角色，当然也有看到一些企业用这个开源系统二次开发为各类边缘计算网关。
...
# CONFIG_PACKAGE_kmod-mhi is not set
...
# CONFIG_PACKAGE_luci-theme-argonn=y
...
# CONFIG_BAIDUPCS_WEB_COMPRESS_UPX is not set
# CONFIG_PACKAGE_brook is not set
# CONFIG_BROOK_COMPRESS_GOPROXY is not set
# CONFIG_BROOK_COMPRESS_UPX is not set
...
# CONFIG_HYSTERIA_COMPRESS_UPX is not set
...
# CONFIG_OVERRIDE_PKGS="aliyundrive-webdav luci-app-aliyundrive-webdav luci-app-frpc"
```

## 编译生成 `.config` 文件
参考 [LEDE](https://github.com/coolsnowwolf/lede) READDME文件
...
你可以自由使用，但源码编译二次发布请注明我的 [GitHub](https://github.com/coolsnowwolf/lede) 仓库链接。谢谢合作！
