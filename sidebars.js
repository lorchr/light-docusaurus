...
const sidebars = {
  ...
  troch: [
    ...
    {
      type: 'category',
      label: 'Spring Authorization Server',
      link: {
        type: 'generated-index',
        title: 'Spring Authorization Server',
        description: 'Spring Authorization Server',
        keywords: ['spring', 'authorization', 'oauth2', 'oauth2.1', 'oidc'],
        image: 'img/docusaurus.png'
      },
      items: [
        {
          type: 'autogenerated',
          dirName: 'zh-cn/spring-authorization-server',
        },
      ],
    },
    {
      ...
      link: {
        ...
        keywords: ['active directory', 'ad', 'adds', 'adfs', 'windows authenticaiton', 'kerberos'],
        image: 'img/docusaurus.png'
      },
      items: [
        {
          type: 'autogenerated',
          dirName: 'zh-cn/active-directory',
        },
      ],
    },
    {
